"""LangChain chains for extracting metadata and query intent."""
...
from app.domain.schemas.query import ADRMetadata, QueryIntent
...
class ExtractionChain:
    ...
    def _get_metadata_extraction_chain(
        ...
        """
        parser = PydanticOutputParser(pydantic_object=ADRMetadata)
